...
@enrollment_bp.route("/change_enrollment_status_for_student/<int:student_id>/<int:course_id>/<string:status>", methods=["PUT"])
def change_enrollment_status_for_student(student_id, course_id, status):

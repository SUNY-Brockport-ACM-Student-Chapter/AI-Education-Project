...
@student_answer_bp.route(
    "/get_student_answers_for_student/<int:student_id>/<int:question_id>",
    methods=["GET"],
)
def get_student_answers_for_student(student_id: int, question_id: int):
    """Get student answers for a student"""
    try:
        student_answers = student_answer_service.get_student_answers_for_student(
...
@student_answer_bp.route(
    "/create_student_answer/<int:student_id>/<int:question_id>", methods=["POST"]
)
def create_student_answer(student_id: int, question_id: int):
    """Create a student answer"""
    try:
        student_answer = student_answer_service.create_student_answer(

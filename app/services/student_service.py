...
class StudentService:
    ...
    def create_new_student(self, user_name: str, first_name: str, last_name: str, email: str, clerk_user_id: str):
        return self.student_repo.create_student(user_name, first_name, last_name, email, clerk_user_id)

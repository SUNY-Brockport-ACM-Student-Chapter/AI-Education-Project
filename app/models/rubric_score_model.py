...
class RubricScore(Base):
    ...
    rubric_score_id = Column(UUID(as_uuid=True), primary_key=True) #ID_REFERENCE
    ...
    rating_id = Column(UUID(as_uuid=True), ForeignKey("rubric_rating.rubric_rating_id"), nullable=True) #ID_REFERENCE
